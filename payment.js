...
const SHOP_PRODUCTS = [
  ...
  {
    id: 'jdm-diecast-sti',
    name: 'WRX STI Lego-Style Model Car',
  ...
  {
    id: 'car-logo-keychain-vw-black',
    name: 'Car Logo Keychain',
    variant: 'Black Volkswagen',
    price: 550,
    category: 'Accessories',
    emoji: '🔑',
  ...
  {
    id: 'car-logo-keychain-vw-white',
    name: 'Car Logo Keychain',
    variant: 'White Volkswagen',
    price: 550,
    category: 'Accessories',
    emoji: '🔑',
    image: 'IMG_20260322_055635754.jpg',
    description: 'White Volkswagen Car Logo Key Chain — zinc alloy VW logo keychain in white finish.',
  },
  {
  ...
  {
    id: 'custom-keychain',
    name: 'Custom Made Car Logo Key Chains',
    variant: 'Submit Your Design via E-mail',
    price: 850,
    category: 'Accessories',
    emoji: '✨',
    image: 'IMG_20260322_132332~2.jpg',
  ...
  // ── Yu Gi Oh Exclusive Trading Cards ─────────────────────────
  {
    id: 'yugioh-card-1',
    name: 'Yu Gi Oh Exclusive Trading Card',
    variant: 'Variant 1',
    price: 0,
    category: 'Collectibles',
    emoji: '🃏',
    image: 'yugioh-card-1.jpg',
  ...
  },
  {
    ...
    category: 'Collectibles',
    emoji: '🃏',
    image: 'yugioh-card-3.jpg',
    description: 'Rare collectible, message for inquiry.',
    comingSoon: true,
  },
  // ── Nolan Ryan MLB Rare Trading Cards ────────────────────────
  {
    id: 'nolan-ryan-card-1',
    name: 'Nolan Ryan MLB Rare Trading Card',
    variant: 'Variant 1',
    price: 0,
    category: 'Collectibles',
    emoji: '⚾',
    image: 'nolan-ryan-card-1.jpg',
    description: 'Rare collectible, message for inquiry.',
    comingSoon: true,
  },
  {
    id: 'nolan-ryan-card-2',
    name: 'Nolan Ryan MLB Rare Trading Card',
    variant: 'Variant 2',
    price: 0,
    category: 'Collectibles',
    emoji: '⚾',
    image: 'nolan-ryan-card-2.jpg',
    description: 'Rare collectible, message for inquiry.',
    comingSoon: true,
  },
  {
    id: 'nolan-ryan-card-3',
    name: 'Nolan Ryan MLB Rare Trading Card',
    variant: 'Variant 3',
    price: 0,
    category: 'Collectibles',
    emoji: '⚾',
    image: 'nolan-ryan-card-3.jpg',
    description: 'Rare collectible, message for inquiry.',
    comingSoon: true,
  },
  {
    id: 'nolan-ryan-card-4',
    name: 'Nolan Ryan MLB Rare Trading Card',
    variant: 'Variant 4',
    price: 0,
    category: 'Collectibles',
    emoji: '⚾',
    image: 'nolan-ryan-card-4.jpg',
    description: 'Rare collectible, message for inquiry.',
    comingSoon: true,
  },
  {
    id: 'nolan-ryan-card-5',
    name: 'Nolan Ryan MLB Rare Trading Card',
    variant: 'Variant 5',
    price: 0,
    category: 'Collectibles',
    emoji: '⚾',
    image: 'nolan-ryan-card-5.jpg',
    description: 'Rare collectible, message for inquiry.',
    comingSoon: true,
  },
  // ── NBA Team USA Olympics Card Set ───────────────────────────
  {
    id: 'nba-team-usa-olympics-set',
    name: 'NBA TEAM USA OLYMPICS CARD SET',
    variant: 'Card Set',
    price: 0,
    category: 'Collectibles',
    emoji: '🏀',
    image: 'nba-team-usa-olympics-set.jpg',
    description: 'Rare collectible, message for inquiry.',
    comingSoon: true,
  },
];
